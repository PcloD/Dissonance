...
public class EditorObjExporter : ScriptableObject
{
	...
	private static string MeshToString (MeshFilter mf, Dictionary<string, ObjMaterial> materialList)
	{
		...
		foreach (Vector3 lv in m.vertices) {
			Vector3 wv = lv;//mf.transform.TransformPoint(lv);
	...
	[MenuItem ("Dissonance/Export/Export models with object centers")]
	...
	[MenuItem ("Dissonance/Export/Export whole selection to single OBJ")]
	...
	[MenuItem ("Dissonance/Export/Export each selected to single OBJ")]
