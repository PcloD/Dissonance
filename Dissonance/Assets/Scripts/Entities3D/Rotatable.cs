...
public class Rotatable : MonoBehaviour
{
		...
		[SerializeField]
		List<IntVector>
				_explicitRelativeRotationAnchors;
		[SerializeField]
		List<RotationAnchorAnimator>
				_explicitRelativeRotationAnchorAnimationSystems;

		[SerializeField]
		float
				_initialRotationAngle = 0f;
		bool _initializedRotation = false;
		...
		void Start ()
		{
				...
				_worldEntity.Rotation = Quaternion.AngleAxis (_initialRotationAngle, Vector3.up);
				_initializedRotation = true;
		...
		public void RotateCounterClockwise (Vector3 worldAnchor)
		{
				...
				if (!CanYRotateAroundAnchor (worldAnchor)) {
						return;
				}
